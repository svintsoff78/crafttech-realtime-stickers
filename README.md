...
### Несогласие с необходимость REST API CRUD
...
- По хорошему передалать монолит в монорепу на nestjs/microservices
- Глобальные модули переделать на forFeature / forRoot, чтобы импортировать просто сервис через DI
- Можно вынести consumer букингов в отдельный микросервис, чтобы обеспечить более высокую горизонтальную масштабируемость в будущем, но для тестового задания это оверхед
- Также можно вынести логику сервисов и консьюмеров в хелперы, но для тестового это тоже оверхед
